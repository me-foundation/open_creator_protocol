 ...
 * @category generated
 */
exports.revokeStruct = new beet.BeetArgsStruct([['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)]], 'RevokeInstructionArgs');
exports.revokeInstructionDiscriminator = [
 ...
 * @category generated
 */
function createRevokeInstruction(accounts, programId = new web3.PublicKey('mtokYxNhZEihbDq3r6LX22pLKnpuQvXV5kwhgCDCWw4')) {
    var _a;
